...
# This page merges About/Publications/Portfolio/Technical Projects/CV into one
# scrollable page (see _layouts/about.html); toc.sidebar builds the left-hand
# quick-nav from the section/category headings, same mechanism the standalone
# pages already use.
toc:
  sidebar: left
---
